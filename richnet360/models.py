...
class BillPayments(models.Model):
    ...
    transactionID = models.CharField(max_length=100, null=True)  # momo transactionID
    paymentType = models.CharField(max_length=50, default='MoMo') # MoMo, Cash, Bank 
...
class Charges(models.Model):
    busID = models.CharField(max_length=50)
    product = models.CharField(max_length=50, default='Monthly Charges')  # Monthly Charges, SMS Charges, IT Support, etc
...
class ChargesType(models.Model):
    ...
    amount = models.FloatField(default=0.00)
    period = models.CharField(max_length=50, default='Not Set')
