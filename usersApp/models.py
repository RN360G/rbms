...
class UserLogs(models.Model):
    ...
    logTitle = models.CharField(max_length=100, default='New activity log')
...
class UserRef(models.Model):
    ...
    userID = models.CharField(max_length=50) # This is the username
    password = models.CharField(max_length=260)
    status = models.CharField(max_length=50, default='Offline') # Online, Offline, Disabled
